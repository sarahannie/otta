...
const Calltoaction = () => {
  ...
  <div className="flex gap-4 items-center flex-col ">
    ...
    <div>
      ...
      <p className="mt-1 text-gray-500 text-center">
        {" "}
        You don&apos;t have to be an expert to enroll in our data analysis course. Our curriculum is designed to be user-friendly.
      </p>
  ...
  <div className="flex gap-4 items-center flex-col ">
    ...
    <div>
      <h3 className="font-semibold text-xl text-center">Flexible Course Format</h3>
      <p className="mt-1 text-gray-500 text-center">
        {" "}
        Our course format is designed to be flexible, allowing you to optimize your website or app for peak performance effortlessly.
      </p>
  ...
  <div className="flex gap-4 items-center flex-col ">
    ...
    <div>
      ...
      <p className="mt-1 text-gray-500 text-center">
        {" "}
        Our comprehensive course material ensures that in the realm of data analysis, our curriculum covers all aspects of the course. 
      </p>
