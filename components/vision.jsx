...
const Vision = () => {
  ...
  <div className="lg:-mx-6 lg:flex lg:items-center">
    <div className="mt-8 lg:w-1/2 lg:px-6 lg:mt-0">
      <p className="text-[15px] font-semibold text-[#2389cf] mission_header mb-5 ">
        Vision
      </p>
      ...
      <div className="mt-10 flex">
        <a
          href="#"
          className="inline-block pb-1 mt-2 text-base font-black text-[#2389cf] uppercase border-b border-transparent hover:border-[#2389cf]"
        >
          Find Out More -&gt;
        </a>
      </div>
